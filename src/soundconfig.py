...
# Project modules
from src.ui.soundconfig import Ui_SoundConfig
from src.package.bases.basestream import StreamDevice


# noinspection PyTypeChecker
class SoundConfig(QWidget, Ui_SoundConfig):
    ...
    def __init__(self, parent=None):
        super(SoundConfig, self).__init__(parent)
        self.setupUi(self)
        ...
        self.devices.addItems(
            [
                ...
                if stream.is_output and stream.host_api == paDirectSound
            ]
        )
