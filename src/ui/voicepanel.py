...
class Ui_VoicePanel(object):
    def setupUi(self, VoicePanel):
        ...
        VoicePanel.setMinimumSize(QtCore.QSize(40, 40))
        VoicePanel.setMaximumSize(QtCore.QSize(94, 60))
        ...
        self.icon_widget.setMinimumSize(QtCore.QSize(40, 40))
        self.icon_widget.setMaximumSize(QtCore.QSize(60, 60))
