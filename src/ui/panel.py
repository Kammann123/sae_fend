...
class Ui_Panel(object):
    def setupUi(self, Panel):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/battery/assets/battery/car+battery+icon-1320184285905906096.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.battery_display.setProperty("icon", icon)
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        ...
        self.horizontalLayout_2.addWidget(self.battery_display)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/thermometer/assets/thermometer/Car_Engine_-_Dashboard_Lights_110-512.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.engine_temperature_display.setProperty("icon", icon1)
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(18)
        ...
        self.horizontalLayout_2.addWidget(self.engine_temperature_display)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/fuel/assets/fuel/fuel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fuel_used_display.setProperty("icon", icon3)
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(18)
        ...
        self.horizontalLayout_2.addWidget(self.fuel_used_display)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/lambda/assets/lambda/lambda-97846_960_720.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.lambda_display.setProperty("icon", icon4)
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(18)
        ...
        self.throttle_display = IconData(Panel)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/throttle/assets/throttle/2303987-200.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.throttle_display.setProperty("icon", icon6)
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(18)
        ...
        self.horizontalLayout_2.addWidget(self.throttle_display)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/thermometer/assets/thermometer/120779.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.air_temperature_display.setProperty("icon", icon7)
        font = QtGui.QFont()
        font.setFamily("Rockwell")
        font.setPointSize(18)
        ...
        self.horizontalLayout_2.addWidget(self.air_temperature_display)
