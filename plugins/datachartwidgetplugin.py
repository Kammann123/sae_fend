...
# Project modules
from datachartwidget import DataChart


class DataChartPlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        super(DataChartPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="DataChart" name="data_chart">\n' \
               ' <property name="toolTip">\n' \
               '  <string>Click and drag here</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis">\n' \
               '  <string>Data Chart Widget. ' \
               ' </string>\n' \
               ' </property>\n' \
               '</widget>\n'

    def includeFile(self):
        return "src/widgets/datachartwidget"
