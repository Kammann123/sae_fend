...
class SoundConfigPlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        super(SoundConfigPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="SoundConfig" name="sound_config">\n' \
               ' <property name="toolTip">\n' \
               '  <string>Click and drag here</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis">\n' \
               '  <string>Sound Config Widget. ' \
               ' </string>\n' \
               ' </property>\n' \
               '</widget>\n'

    def includeFile(self):
        return "src/soundconfig"
