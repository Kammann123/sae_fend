...
# Project modules
from messageinput import MessageInputWidget


class MessagesInputWidgetPlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        super(MessagesInputWidgetPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        return MessageInputWidget(parent)
    ...
    def domXml(self):
        return '<widget class="MessageInputWidget" name="message_input_widget">\n' \
               ' <property name="toolTip">\n' \
               '  <string>Click and drag here</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis">\n' \
               '  <string>Message Input Widget. ' \
               ' </string>\n' \
               ' </property>\n' \
               '</widget>\n'

    def includeFile(self):
        return "src/messageinput"
