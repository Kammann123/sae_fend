...
class MessagesWidgetPlugin(QPyDesignerCustomWidgetPlugin):

    def __init__(self, parent=None):
        super(MessagesWidgetPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="MessagesWidget" name="messages_widget">\n' \
